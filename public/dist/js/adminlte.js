...
(function (global, factory) {
  ...
  var Fullscreen = /*#__PURE__*/ (function () {
      ...
      Fullscreen._jQueryInterface = function _jQueryInterface(config) {
          ...
          if (
              typeof config === "string" &&
              /toggle|fullscreen|windowed/.test(config)
          ) {
              plugin[config]();
          } else {
              plugin.init();
  ...
  var SELECTOR_TAB_NAVBAR_NAV =
      SELECTOR_DATA_TOGGLE$1 + ".iframe-mode .navbar-nav";
  var SELECTOR_TAB_NAVBAR_NAV_ITEM = SELECTOR_TAB_NAVBAR_NAV + " .nav-item";
  var SELECTOR_TAB_NAVBAR_NAV_LINK = SELECTOR_TAB_NAVBAR_NAV + " .nav-link";
  var SELECTOR_TAB_CONTENT =
      SELECTOR_DATA_TOGGLE$1 + ".iframe-mode .tab-content";
      ...
      _proto._init = function _init() {
          if (window.frameElement && this._config.autoIframeMode) {
              ...
              if (
                  ...
                  var $el = $__default["default"](
                      SELECTOR_TAB_PANE + ":first-child"
                  );
                  $el.show();
