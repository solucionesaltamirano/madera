...
<html lang="es">
    ...
    <body width="95%" style="margin: 0; padding-bottom: 15px ; padding-top: 15px !important; mso-line-height-rule: exactly; background-color: #fbfbfb;">

        <img src="{{ asset('img/logo.svg') }}" alt="{{ config('app.name') }}" style=" display: block; margin-left: auto;
        margin-right: auto;" height="100"> 
        
        <h1 align="center" style="color:darkblue; padding-top: 10px; ">
            Backup de la base de datos
        </h1>

        <a href="{{ asset('storage/backups/' . $filename) }}">
            Backup_{{ date('Y-m-d') }}
        </a>

        <p style="margin-left: 5%; padding-top: 20px;">Correo enviado automaticamente por el sistema.</p>
